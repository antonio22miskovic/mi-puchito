...
Vue.component('piso-ventas-precios', require('./view/PisoVentasPrecios.vue').default);
Vue.component('piso-ventas-anclar', require('./view/PisoVentasAnclar.vue').default);
