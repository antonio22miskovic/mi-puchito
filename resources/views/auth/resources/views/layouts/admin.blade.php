...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		...
		<ul class="navbar-nav ml-auto">
			...
			-->
			<li class="nav-item dropdown" id="piso-ventas">
				<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
					<i class="fas fa-user mr-2"></i> Pisos de ventas
				</a>
				<div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
					{{-- <a class="dropdown-item" href="/admin/cuentas-bancarias">Códigos de descuentos</a> --}}
					<a class="dropdown-item" href="{{ route('piso.ventas.index') }}">Ver</a>
					<a class="dropdown-item" href="{{ route('despachos.almacen.index') }}">Despachos</a>
					<div class="dropdown-divider"></div>
					<a class="dropdown-item" href="{{ route('piso.ventas.precios') }}">Precios</a>
					<a class="dropdown-item" href="{{ route('piso.ventas.anclar') }}">Precios Anclar producto</a>
				</div>
			</li>
			<!--
